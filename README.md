...
- **Run cool**: `pana mode eco` (caps CPU clock ceiling → less heat & draw) ↔ `pana mode performance`
...
- **Lights**: `pana lights off|on|--brightness 0-9|--color RRGGBB|--effect static|rainbow|breathe`; `pana night on|off|clear`
